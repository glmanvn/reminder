...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'D:\\Projects\\PHP\\reminder\\site\\log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'D:\\Projects\\PHP\\reminder\\site\\cache\\frontend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'D:\\Projects\\PHP\\reminder\\site\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'D:\\Projects\\PHP\\reminder\\site\\cache\\frontend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'D:\\Projects\\PHP\\reminder\\site\\apps\\frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'mail.diamondbayresort.vn',
      'port' => 25,
      'encryption' => NULL,
      'username' => 'dbreminder@diamondbayresort.vn',
      'password' => 'db@re',
    ),
  ),
))));
