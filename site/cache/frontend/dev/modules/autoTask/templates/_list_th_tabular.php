...
<th class="sf_admin_text sf_admin_list_th_taskName">
  <?php echo __('Tên công việc', array(), 'messages') ?>
</th>
<?php end_slot(); ?>
...
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
<th class="sf_admin_text sf_admin_list_th_statusMin">
  <?php echo __('Trạng thái', array(), 'messages') ?>
</th>
<?php end_slot(); ?>
