...
$response = $this->context->getResponse();
  ...
  $this->setComponentSlot('sidebar', 'leftpanel', 'user');
  if (sfConfig::get('sf_logging_enabled')) $this->context->getEventDispatcher()->notify(new sfEvent($this, 'application.log', array(sprintf('Set component "%s" (%s/%s)', 'sidebar', 'leftpanel', 'user'))));
  $response->addHttpMeta('content-type', 'text/html', false);
  $response->addMeta('title', 'Ticket reminder Admin page', false, false);
  $response->addMeta('description', 'Ticket reminder Admin page', false, false);
