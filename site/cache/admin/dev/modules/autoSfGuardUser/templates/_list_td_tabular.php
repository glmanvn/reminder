...
<td class="sf_admin_text sf_admin_list_td_fullname">
  <?php echo get_partial('sfGuardUser/fullname', array('type' => 'list', 'sf_guard_user' => $sf_guard_user)) ?>
</td>
...
<td class="sf_admin_date sf_admin_list_td_updated_at">
  <?php echo false !== strtotime($sf_guard_user->getUpdatedAt()) ? format_date($sf_guard_user->getUpdatedAt(), "yyyy/MM/dd hh:mm:ss") : '&nbsp;' ?>
</td>
<td class="sf_admin_date sf_admin_list_td_last_login">
  <?php echo false !== strtotime($sf_guard_user->getLastLogin()) ? format_date($sf_guard_user->getLastLogin(), "yyyy/MM/dd hh:mm:ss") : '&nbsp;' ?>
</td>
