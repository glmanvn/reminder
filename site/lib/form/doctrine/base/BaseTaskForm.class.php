...
abstract class BaseTaskForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'task_name'        => new sfWidgetFormTextarea(),
      'task_description' => new sfWidgetFormTextarea(),
      'piriority'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'task_name'        => new sfValidatorString(array('max_length' => 500)),
      'task_description' => new sfValidatorString(array('required' => false)),
      'piriority'        => new sfValidatorInteger(array('required' => false)),
      'assigned_to'      => new sfValidatorString(array('max_length' => 500, 'required' => false)),
